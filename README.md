About jsonapi-client-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsonapi-client-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3018&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsonapi-client-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsonapi-client` can be installed with `conda`:
...
```
mamba install jsonapi-client
```

It is possible to list all of the versions of `jsonapi-client` available on your platform with `conda`:
...
```
mamba search jsonapi-client --channel conda-forge
```
...
mamba repoquery search jsonapi-client --channel conda-forge

# List packages depending on `jsonapi-client`:
mamba repoquery whoneeds jsonapi-client --channel conda-forge

# List dependencies of `jsonapi-client`:
mamba repoquery depends jsonapi-client --channel conda-forge
```
...
* [@emilhaegglund](https://github.com/emilhaegglund/)
